...
for subset in subsets:
    ...
    for num in [4096]:
        ...
        for id in progress_bar:
            ...
            H = scio.loadmat(os.path.join(subset_path, 'test', 'homo') + '/' + image_list[id].replace('.png',
                                                                                                            '.mat'))[
                'H']
        ...
        if not os.path.exists('.\\results\\{}\\{}\\{}\\'.format(subset, feature_name, num)):
            os.makedirs('.\\results\\{}\\{}\\{}\\'.format(subset, feature_name, num))
        savemat(
            os.path.join(os.path.join(SCRIPT_DIR, 'results', subset, feature_name, 'match_result_{}.mat'.format(num))),
            {'N_corr': N_corr, 'N_k1': N_k1, 'N_k2': N_k2, 'N_correctmatches': N_corretmatches,
