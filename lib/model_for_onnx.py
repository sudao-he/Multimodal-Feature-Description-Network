...
class MFDN(nn.Module):
    ...
    def forward(self, img1_multiscale, img2_multiscale):
        feat1_multiscale = []
        score1_multiscale = []
        for img in img1_multiscale:
            feat1, score1 = self.forward1(img)
            feat1_multiscale.append(feat1)
            score1_multiscale.append(score1)
        feat2_multiscale = []
        score2_multiscale = []
        for img in img2_multiscale:
            feat2, score2 = self.forward2(img)
            feat2_multiscale.append(feat2)
            score2_multiscale.append(score2)
        return feat1_multiscale, feat2_multiscale, score1_multiscale, score2_multiscale
