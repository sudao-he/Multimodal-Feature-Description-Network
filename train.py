...
# from lib.model_full import MFDN
from lib.loss import MMLoss
from lib.model import MFDN
import warnings
import os
...
def train(args):
    ...
    log_file_path = 'logs/{:.2f}_{:.2f}.txt'.format( args.lam1, args.lam2)
    ...
    for epoch_idx in range(1, args.num_epochs + 1):
        ...
        checkpoint_path = '{}/{:.2f}_{:.2f}_{:d}.pth'.format(args.name, args.lam1, args.lam2, epoch_idx)
        checkpoint = {
            'args': args,
            'epoch_idx': epoch_idx,
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--name', type=str, default='checkpoint',
        help='directory for training checkpoints'
    )
    

    parser.add_argument(
        '--image_type', type=str, default='VIS_IR',
        help='type of training images VIS_IR, VIS_NIR, VIS_SAR'
    )

    parser.add_argument(
        '--datapath', type=str, default='./open-dataset/',
    ...
    parser.add_argument(
        '--lam1', type=float, default=64,
        help='weight for peaking loss'
    )
    parser.add_argument(
        '--lam2', type=float, default=64,
